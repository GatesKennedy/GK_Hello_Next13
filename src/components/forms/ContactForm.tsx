...
export default function ContactForm() {
	...
	const bgThick: string = useColorModeValue('whiteAlpha.700', 'blackAlpha.200');
	const {
		register,
		handleSubmit,
		formState: { errors },
	...
	return (
		<Flex id="contactFlex" align="center" justify="center" height="full">
			<Box
				id={'ContactBox'}
				borderRadius="lg"
				mx={{ base: 4, md: 4, lg: 4 }}
				p={{ base: 2, lg: 4 }}
			>
				<VStack id={'contact-stack'} spacing={{ base: 1, md: 4, lg: 8 }}>
					<Heading
						fontSize={{
							base: '2xl',
							md: '5xl',
					...
					{formViz ? '' : <Text fontSize={'md'}>{`( Check your email )`}</Text>}
